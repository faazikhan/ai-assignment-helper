      ...
      input: [
        {
          ...
          content: [
            {
              type: "input_text",
              text: "You are a helpful academic tutor. Always answer in 250 to 300 words or fewer. Even if the user asks for a longer answer, never exceed 250 words. Be clear, direct, and concise."
            }
          ]
        },
        {
